...
const WeatherApp = () => {
    let api_key = "131dac3d8a72856bba110854fdd2b15f"
    ...
    const search = async () =>{
        ...
        if(element[0].value==="")
        {
            toast.error("Enter City Name", {position:"top-center",theme: "colored"});
            return 0;  
        }
        ...
        {
            toast.error("Enter Correct City Name", {position:"top-center",theme: "colored"});
            return 0;
        }
